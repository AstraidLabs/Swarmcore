...
{
    /// <summary>Returns the base announce URL, e.g. https://tracker.example.com/announce</summary>
    string GetAnnounceUrl();

    /// <summary>Returns the passkey-scoped announce URL, e.g. https://tracker.example.com/announce/&lt;passkey&gt;</summary>
